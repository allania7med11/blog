...
enum CSS {
    navbar = "z-20 text-left h-screen text-lg font-medium truncate bg-gray-800 whitespace-nowrap fixed top-14 left-0 flex flex-col pl-4 pb-4 pt-2   text-gray-400"
}
